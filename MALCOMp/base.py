...
class Base:
    ...
    def __init__(self, stage_name, config_path="config.yaml"):
        ...
        self.assets_dir = self._resolve_path(self.config.get("assets_dir", "assets"))
        self.output_dir = self._resolve_path(self.config.get("output_dir", "output"))
        ...
        self.requirement_file = str(self._resolve_path(self.stage_config["requirement_file"]))
