	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Base_Package.UTILITY_ELEMENT: {
				...
				if (result == null) result = caseModelElement(utilityElement);
			...
			case Base_Package.IMPLEMENTATION_CONSTRAINT: {
				...
				if (result == null) result = caseModelElement(implementationConstraint);
			...
			case Base_Package.TAGGED_VALUE: {
				...
				if (result == null) result = caseModelElement(taggedValue);
