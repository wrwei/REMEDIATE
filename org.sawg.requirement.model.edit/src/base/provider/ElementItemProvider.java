...
public class ElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_gid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_gid_feature", "_UI_Element_type"),
				 Base_Package.Literals.ELEMENT__GID,
				 true,
				 false,
				 false,
	...
	protected void addIsCitationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_isCitation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_isCitation_feature", "_UI_Element_type"),
				 Base_Package.Literals.ELEMENT__IS_CITATION,
				 true,
				 false,
				 false,
	...
	protected void addIsAbstractPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_isAbstract_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_isAbstract_feature", "_UI_Element_type"),
				 Base_Package.Literals.ELEMENT__IS_ABSTRACT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addCitedElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_citedElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_citedElement_feature", "_UI_Element_type"),
				 Base_Package.Literals.ELEMENT__CITED_ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Element)object).getGid();
