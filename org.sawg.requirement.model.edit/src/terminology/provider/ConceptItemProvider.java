...
/**
 * This is the item provider adapter for a {@link terminology.Concept} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConceptItemProvider extends TerminologyAssetItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Terminology_Package.Literals.CONCEPT__CONCEPT);
		}
	...
	public String getText(Object object) {
		String label = ((Concept)object).getGid();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Concept.class)) {
			case Terminology_Package.CONCEPT__CONCEPT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Terminology_Package.Literals.CONCEPT__CONCEPT,
				 Terminology_Factory.eINSTANCE.createConcept()));
	}
