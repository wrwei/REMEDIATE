...
/**
 * This is the item provider adapter for a {@link terminology.Instance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstanceItemProvider extends TerminologyAssetItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Instance_concept_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Instance_concept_feature", "_UI_Instance_type"),
				 Terminology_Package.Literals.INSTANCE__CONCEPT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Instance)object).getGid();
