 ...
 * @generated
 */
public class Bifrost_Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static Bifrost_Package modelPackage;
	 ...
	 * @generated
	 */
	public Bifrost_Switch() {
		if (modelPackage == null) {
			modelPackage = Bifrost_Package.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Bifrost_Package.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bifrost_Package.TRACE_PACKAGE: {
				TracePackage tracePackage = (TracePackage)theEObject;
				T result = caseTracePackage(tracePackage);
				if (result == null) result = caseNamedElement(tracePackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bifrost_Package.TRACE_PACKAGE_INTERFACE: {
				TracePackageInterface tracePackageInterface = (TracePackageInterface)theEObject;
				T result = caseTracePackageInterface(tracePackageInterface);
				if (result == null) result = caseTracePackage(tracePackageInterface);
				if (result == null) result = caseNamedElement(tracePackageInterface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bifrost_Package.TRACE_ELEMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Trace Package Interface</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Trace Package Interface</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTracePackageInterface(TracePackageInterface object) {
		return null;
	}
