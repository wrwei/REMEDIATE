...
/**
 * This is the item provider adapter for a {@link bifrost.NamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NamedElement_gid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NamedElement_gid_feature", "_UI_NamedElement_type"),
				 Bifrost_Package.Literals.NAMED_ELEMENT__GID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Bifrost_Package.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NamedElement.class)) {
			case Bifrost_Package.NAMED_ELEMENT__GID:
			case Bifrost_Package.NAMED_ELEMENT__NAME:
	...
	public ResourceLocator getResourceLocator() {
		return BifrostEditPlugin.INSTANCE;
	}
