...
/**
 * This is the item provider adapter for a {@link bifrost.Trace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TraceItemProvider extends TraceElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trace_updated_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trace_updated_feature", "_UI_Trace_type"),
				 Bifrost_Package.Literals.TRACE__UPDATED,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Bifrost_Package.Literals.TRACE__SOURCE);
			childrenFeatures.add(Bifrost_Package.Literals.TRACE__TARGET);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Bifrost_Package.Literals.TRACE__SOURCE,
				 Bifrost_Factory.eINSTANCE.createExternalReference()));

		newChildDescriptors.add
			(createChildParameter
				(Bifrost_Package.Literals.TRACE__TARGET,
				 Bifrost_Factory.eINSTANCE.createExternalReference()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Bifrost_Package.Literals.TRACE__SOURCE ||
			childFeature == Bifrost_Package.Literals.TRACE__TARGET;
